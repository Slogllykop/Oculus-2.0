interface WebstoreIconProps extends React.HTMLAttributes<HTMLElement> {
    fill?: string;
}

const WebstoreIcon: React.FC<WebstoreIconProps> = ({ className, fill }): React.ReactElement => {
    return (
        <svg
            role="img"
            viewBox="0 0 24 24"
