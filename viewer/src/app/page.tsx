	...
	return (
		<main className="min-h-screen bg-black flex flex-col">
			...
			<section className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center relative overflow-hidden">
				{/* Subtle teal glow */}
				<div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] rounded-full bg-brand-600/8 blur-3xl pointer-events-none" />
				...
				<div className="relative space-y-6 max-w-3xl">
					...
					<h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight tracking-tight">
						Share your screen
						<span className="block text-brand-400 mt-1">with anyone</span>
					</h1>

					<p className="text-lg text-zinc-400 max-w-xl mx-auto leading-relaxed">
						Instant, peer-to-peer screen broadcasting. Install the Chrome
						extension, click{" "}
						<strong className="text-white">Start Sharing</strong>, and send the
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-semibold transition-all shadow-lg shadow-brand-900/30 hover:scale-[1.02]"
						>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 max-w-4xl w-full relative">
					{[
						...
						<div
							key={title}
							className="p-6 rounded-2xl bg-white/[0.02] border border-white/[0.07] hover:border-brand-500/30 hover:bg-white/[0.04] transition-all text-left group"
						>
							<div className="w-10 h-10 rounded-xl bg-brand-500/10 border border-brand-500/20 flex items-center justify-center mb-4 group-hover:bg-brand-500/15 transition-colors">
			...
			{/* Footer */}
			<footer className="border-t border-white/[0.06] px-8 py-6 flex items-center justify-between text-xs text-zinc-700">
